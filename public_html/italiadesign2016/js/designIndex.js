...
$(document).ready(function() {
	...
	*********************************************/
	...
	var resultsHeight = $window.outerHeight(true) - $(".past-links-cont").outerHeight(true);
	console.log(resultsHeight);
	$(".results-container").css('min-height', resultsHeight);
	if(mobile) {
	...
	********************************/
	...
	searchScroll = function() {
		var scrollPos = $window.scrollTop(),
			...
			// formPos = $window.outerHeight() * 0.18,
	...
	** ============================*/
	...
	function showSearch() {
		...
		if ($window.outerWidth() < 1024) $("#search-btn").css('opacity', 0);
		...
		searchPos = $window.outerHeight() * 0.18;
		searchScroll();
	...
	function hideSearch() {
		...
		if ($window.outerWidth() < 1024) $("#search-btn").css('opacity', 1);
	...
	** ============================*/
	...
	function $filterResults() {
		...
		for (var year = 2012; year <= 2016; year++) {
			...
			if (!$("#flex-grid-" + year + " [class*='-entry']").not(".dHidden").length) {
	...
	** =====================================================*/
	...
	$window.on('load', function() {
		// if(mobile) {
		// 	$('#d-filter').detach().appendTo('nav');
		// 	$('#year-links').detach().appendTo('nav');
		// }
	...
	//TODO: The scrolling when you click a year is being funky. Return later.
	// $("[id*='year-title-']").on('click', scrollToYear(event));
